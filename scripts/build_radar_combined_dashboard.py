...
Office, Toilet, Toilet Boven, Backdoor, Storage, Overloop, and Badkamer (entity id
substitution) and adds input_select visibility so the UI dropdown still works.
...
RADAR_LOCATIONS = [
    ...
    ("Office", "radar_office"),
    ("Toilet", "radar_toilet"),
    ("Toilet Boven", "toilet_2_radar_toilet_boven"),
